...
static bool
s_sendmore (zmq::socket_t & socket, const std::string & string) __attribute__((unused));
static bool
...
//
static void s_dump (zmq::socket_t & socket) __attribute__((unused));
...
//
static void s_version (void) __attribute__((unused));
...
static void
s_version_assert (int want_major, int want_minor) __attribute__((unused));
static void
...
static int64_t s_clock (void) __attribute__((unused));
...
static void
s_sleep (int msecs) __attribute__((unused));
static void
s_sleep (int msecs)
{
#if (defined (WIN32))
...
static void
s_console (const char *format, ...) __attribute__((unused));
static void
...
static void s_catch_signals () __attribute__((unused));
