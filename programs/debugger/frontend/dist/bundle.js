...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(81)(module), __webpack_require__(1)))
...
class Application extends React.Component {
    ...
    render() {
        return (React.createElement("div", null,
            React.createElement("div", { className: 'dbg-header' },
                React.createElement("div", { className: 'dbg-header-spacer' }, " "),
                React.createElement("h1", null, "libproc Debugger")),
            React.createElement("div", { className: 'dbg-body' },
                React.createElement("div", { className: 'dbg-body-spacer' }, " "),
                React.createElement("h2", null, this.state.process_name),
                React.createElement("div", { className: 'dbg-content' },
                    React.createElement("div", null,
                        React.createElement(events_1.Events, { type: 'timedevents', timedevents: this.state.timed_events })),
                    React.createElement("div", null,
                        React.createElement(events_1.Events, { type: 'fdevents', fdevents: this.state.fd_events }))),
                React.createElement("div", { className: "dbg-footer" }))));
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(11);
const sprintf_js_1 = __webpack_require__(79);
class Events extends React.Component {
    render() {
        ...
        if (this.props.type == 'fdevents') {
            name = 'FD Events';
            events = this.props.fdevents.map((e) => {
                return React.createElement(FDEvent, { key: e.id, event: e });
            });
        }
        else {
            name = 'Timed Events';
            events = this.props.timedevents.map((e) => {
                return React.createElement(TimedEvent, { key: e.id, event: e });
            });
        }
        return (React.createElement("div", { className: 'dbg-events-container' },
            React.createElement("h3", null, name),
            React.createElement("div", { className: 'dbg-events-cards' }, events)));
    }
}
exports.Events = Events;
const FDEvent = (props) => {
    return (React.createElement("div", { className: "dbg-event-card" },
        React.createElement("h4", null, props.event.filename),
        React.createElement("p", null,
            "Read Handler: ",
            props.event.read_handler ? props.event.read_handler : 'None'),
        React.createElement("p", null,
            "Write Handler: ",
            props.event.write_handler ? props.event.write_handler : 'None'),
        React.createElement("p", null,
            "Error Handler: ",
            props.event.error_handler ? props.event.error_handler : 'None')));
};
function getTimeStr(time) {
    let secs = time % 60;
    let mins = Math.floor(time / 60) % 60;
    let hours = Math.floor(mins / 60);
    let timeStr = sprintf_js_1.sprintf('%02d:%02d', mins, secs);
    if (hours > 0) {
        timeStr = sprintf_js_1.sprintf('%02d:', hours) + timeStr;
    }
    return timeStr;
}
const TimedEvent = (props) => {
    ...
    return (React.createElement("div", { className: "dbg-event-card" },
        React.createElement("div", { className: 'dbg-timedevent-body' },
            React.createElement("h4", null, props.event.function),
            React.createElement("p", null,
                "arg: ",
                props.event.arg_pointer)),
        React.createElement("div", { className: 'dbg-timedevent-time' },
            React.createElement("h2", null, getTimeStr(time)),
            React.createElement("p", null,
                "/",
                getTimeStr(props.event.event_length)))));
};
...
*/
var aa=__webpack_require__(11),l=__webpack_require__(43),B=__webpack_require__(20),C=__webpack_require__(14),ba=__webpack_require__(42),da=__webpack_require__(46),ea=__webpack_require__(49),fa=__webpack_require__(44),ia=__webpack_require__(45),D=__webpack_require__(19);
...
var m=__webpack_require__(20),n=__webpack_require__(19),p=__webpack_require__(14),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
