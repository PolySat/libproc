...
static struct ServiceNames {
   ...
   { "star_tracker", 50015, "234.192.101.16", { 0 }, 51015 },
   { "camera", 50016, "234.192.101.17", { 0 }, 51016 },
   { "payload2", 50017, "234.192.101.18", { 0 }, 51017 },
   { "payload3", 50018, "234.192.101.10", { 0 }, 51018 },
   { "payload3", 50019, "234.192.101.20", { 0 }, 51019 },
